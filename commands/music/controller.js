...
module.exports = {
    ...
    async execute({ inter, client }) {
        ...
        if (Channel.type !== 0) return inter.editReply({ content: `Il faut l'envoyer dans le salon textuel.. ❌`, ephemeral: true })
        ...
        inter.editReply({ content: `envoie du contrôleur sur ${Channel}... ✅`, ephemeral: true })
